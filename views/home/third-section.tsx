      ...
      <div className="mt-10 md:mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0">
        ...
        <div className="md:pl-8 xl:pl-16 md:border-l border-grey-450">
          <div className="md:pt-5">
            ...
            <p className="text-xl md:text-2xl font-medium mt-2">220,000 xNGN</p>
          </div>
          ...
          <div className="mt-8 md:mt-[60px]">
            ...
            <p className="text-xs md:text-sm text-grey-500">
              <span className="text-red-50">*</span>This is the amount that you
              can generate at 150% collateralization ratio. We recommend keeping
              you collateralization ratio higher and generating less to keep
              your position open, in case the value of your USDC collateral
              drops.
            </p>
          </div>
        </div>
